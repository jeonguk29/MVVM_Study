...
final class ListViewController: UIViewController {
    ...
    let viewModel: MemberListViewModel // 뷰모델을 가짐
...
extension ListViewController: UITableViewDataSource {
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        return viewModel.numberOfRowsInSection(section) // 뷰모델에게 물어봐서 처리하게 할수 있음 viewModel.membersList.count 이렇게 할수도 있지만 직접 기능을 구현해서 처리하게 할수도 있는 것임
    }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.viewModel = memberVM // 뷰 모델을 생성하여 전달함
