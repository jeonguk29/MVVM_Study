...
class ViewController: UIViewController {
    ...
    var comChoice: Rps = Rps.allCases[Int.random(in: 1...3)] // allCases 는 열거형 타입이 가진 모든 타입을 담은 배열을 리턴해줌
    ...
    @IBAction func selectButtonTapped(_ sender: UIButton) {
        ...
        mainLabel.text = rpsManager.getRpsResult(comChoice: self.comChoice, myChoice: self.myChoice) // 문자열 결과를 반환하도록
    }
